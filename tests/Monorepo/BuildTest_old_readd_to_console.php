...
class BuildTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $build = new Build();
        $packages = $build->loadPackages($this->getContext(__DIR__ . '/../_fixtures/example-simple'));
    ...
    {
        $build = new Build();
        $packages = $build->loadPackages($this->getContext(__DIR__ . '/../_fixtures/example-composer'));
    ...
    public function testBuildSimpleExampleProject()
    {
        ...
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-simple'));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-replace'));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-provide'));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-advanced'));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-vendordir'));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-relbin'));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-nodev', true, true));
    ...
    {
        $build = new Build();
        $build->build($this->getContext(__DIR__ . '/../_fixtures/example-include-path'));
     ...
     * @return Context
     */
    private function getContext($rootDirectory, $optimize = false, $noDevMode = false)
    {
        return ContextBuilder::create()
            ->build($rootDirectory, $optimize, $noDevMode);
    }
